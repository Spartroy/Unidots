            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <p className="text-blue-800 text-sm">
                  AI-powered quality control system for analyzing printing dot patterns and detecting deformation issues.
                </p>
              </div>
            </div>
          </div>
                        ...
                        <div className="border-t border-gray-200 pt-4">
                          <div className={`rounded-md p-3 ${
                            ...
                            <p className={`text-sm ${
                              ...
                              {prediction.class === 'good' 
                                ? '✅ The dot pattern appears to be properly formed with minimal deformation. Quality meets standards.'
                                : '⚠️ The dot pattern shows signs of deformation that may affect print quality. Review recommended.'
                              }
                            </p>
                          </div>
                        </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-600 text-sm">
                  ...
                  <li>Wait for the AI model to analyze the image (usually takes 5-10 seconds)</li>
                  <li>Review the quality assessment and confidence score</li>
                  <li>Use the results to determine if the print quality meets production standards</li>
                </ol>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-600 text-sm">
                  ...
                  <li>Include sufficient dot pattern area in the frame</li>
