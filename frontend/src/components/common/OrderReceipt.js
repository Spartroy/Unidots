...
const OrderReceiptDocument = ({ order }) => {
  ...
  const getPriceBreakdown = () => {
    ...
    return {
      ...
      repeats: `W: ${widthRepeat} × H: ${heightRepeat}`,
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{order.specifications?.materialThickness || 'N/A'} microns</Text>
          </View>
          <View style={styles.row}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.priceRow}>
            <Text style={styles.priceLabel}>Calculation Formula:</Text>
            <Text style={styles.priceValue}>((W × WR) × (H × HR) × Colors) × Factor</Text>
          </View>
        ...
        <Text style={styles.footer}>
          ...
          {'\n'}Thank you for your business! For inquiries, contact us at info@unidots.com
        </Text>
      </Page>
    </Document>
  );
