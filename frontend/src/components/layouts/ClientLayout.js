...
const ClientLayout = () => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/client', current: location.pathname === '/client' },
    { name: 'Orders', href: '/client/orders', current: location.pathname.startsWith('/client/orders') },
    { name: 'Claims', href: '/client/claims', current: location.pathname.startsWith('/client/claims') },
  ];
              ...
              <div className="flex h-16 items-center justify-between">
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    <button
                      type="button"
                      className="rounded-full bg-primary-600 p-1 text-primary-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600"
                    >
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="border-t border-primary-700 pb-3 pt-4">
                <div className="flex items-center px-5">
                  ...
                  <button
                    type="button"
                    className="ml-auto flex-shrink-0 rounded-full bg-primary-600 p-1 text-primary-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600"
                  >
                    <span className="sr-only">View notifications</span>
                    <BellIcon className="h-6 w-6" aria-hidden="true" />
                  </button>
      ...
      <header className="bg-white shadow">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">
            {navigation.find(item => item.current)?.name || 'Client Portal'}
          </h1>
        </div>
      </header>
      <main>
