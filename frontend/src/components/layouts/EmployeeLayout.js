            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex h-16 items-center justify-between">
                        ...
                        <Link
                          ...
                          className={classNames(
                            item.current
                              ...
                              : 'text-white hover:bg-secondary-500 hover:bg-opacity-75',
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <Menu as="div" className="relative ml-3">
                      <div>
                        <Menu.Button className="flex max-w-xs items-center rounded-full bg-secondary-600 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-secondary-600">
                ...
                <div className="-mr-2 flex md:hidden">
                  {/* Mobile menu button */}
                  <Disclosure.Button className="inline-flex items-center justify-center rounded-md bg-secondary-600 p-2 text-secondary-200 hover:bg-secondary-500 hover:bg-opacity-75 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-secondary-600">
              ...
              <div className="border-t border-secondary-700 pb-3 pt-4">
                ...
                <div className="mt-3 space-y-1 px-2">
                  <Disclosure.Button
                    as={Link}
                    to="/employee/profile"
                    className="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-secondary-500 hover:bg-opacity-75"
                  >
                    Your Profile
                  </Disclosure.Button>
                  <Disclosure.Button
                    as="button"
                    onClick={logout}
                    className="block w-full text-left rounded-md px-3 py-2 text-base font-medium text-white hover:bg-secondary-500 hover:bg-opacity-75"
                  >
                    Sign out
                  </Disclosure.Button>
                </div>
